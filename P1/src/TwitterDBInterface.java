...
public interface TwitterDBInterface {
	 ...
	 * stored in the database. Argument: None Returns: the most common word
	 */
	...
	/*
	 * computes the frequency of the given word in the database Argument: the
	 * word to be searched Returns: an integer which counts the number of
	 * occurrences of the given word in the database
	 */
